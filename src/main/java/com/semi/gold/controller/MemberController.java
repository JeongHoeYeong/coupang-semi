...
public class MemberController {
	...
	@GetMapping("/findpwd")
	public void searchMypwd() {}
	@GetMapping("/findpwd2")
	public void searchMypwd2(Model model) {
		model.addAttribute("id", searchMember.getId());
	}
	
	@ResponseBody
	@PostMapping("/searchpwd")
	public boolean searchpwd(Member m) {
		searchMember = service.searchpwd(m);
		if(searchMember == null) return false;
		return true;
	}
	
	@PostMapping("/searchUpdate")
	public String searchupdate(Member vo, HttpServletRequest request) {
