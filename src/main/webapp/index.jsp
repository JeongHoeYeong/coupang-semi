    ...
    >
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img
            src="resources/image/충청북도_단양.jpg"
            class="d-block w-100"
            alt="..."
          />
        ...
        <div class="carousel-item">
          <img
            src="resources/image/전라북도_전주.jpg"
            class="d-block w-100"
            alt="..."
          />
          <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item">
          <img
            src="resources/image/전라남도_광주.jpg"
            class="d-block w-100"
            alt="..."
          />
          <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item">
          <img
            src="resources/image/인천_소래포구.jpg"
            class="d-block w-100"
            alt="..."
          />
          <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item">
          <img
            src="resources/image/부산_해운대.jpg"
            class="d-block w-100"
            alt="..."
          />
          <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item">
          <img
            src="resources/image/경상북도_경주.jpg"
            class="d-block w-100"
            alt="..."
          />
          <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item">
          <img
            src="resources/image/경상남도_통영.jpg"
            class="d-block w-100"
            alt="..."
          />
          <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item">
          <img
            src="resources/image/경기도_수원.jpg"
            class="d-block w-100"
            alt="..."
          />
          <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item">
          <img
            src="resources/image/강원도_속초.jpg"
            class="d-block w-100"
            alt="..."
          />
          <div class="carousel-caption d-none d-md-block">
        ...
        <div class="row py-4">
          <div class="col-lg-3 col-12 align-left">
            <a class="navbar-brand" href="/">
              ...
              <span class="text-light h5">Purple</span>
              <span class="text-light h5 semi-bold-600">Buzz</span>
            </a>
