			...
			<div class="flex-fill mx-xl-6 mb-2 ">
				<ul
					...
					<li class="nav-item"><a
						...
						href="tourplace/search">여행을 만나는 순간</a></li>
					<li class="nav-item"><a
						class="nav-link btn-outline-warning rounded-pill px-3">맛집를 만나는
							순간</a></li>
					<li class="nav-item"><a
...
<div class="container-fluid" style="padding: 35px">
	<div class="col-md-5">
		<select class="form-select py-2 text-center">
			...
			<option value="food">맛집</option>
			<option value="stay">숙박</option>
		</select> <select class="form-select py-2 text-center">
			<option value="select" selected>지역</option>
			<option value="seoul">서울</option>
			<option value="">경기도</option>
			<option value="location">경상남도</option>
		...
		<div class="col-md-2 px-5">
			<button class="btn btn-warning px-5" id="search">Click!</button>
		</div>
	</div>
</div>
<!-- Start Recent Work -->
