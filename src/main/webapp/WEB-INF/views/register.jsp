		...
		<div class="member">
			...
			<div class="field">
				<b>아이디</b> <input type="text" id="id" name="id" placeholder="아이디 입력"
					...
					style="height: 20px; display: block"></span>
			</div>

			<div class="field">
				<b>비밀번호</b> <input class="password" type="password" name="password"
					id="password" placeholder="비밀번호 입력" /> <span id="passwordText"
					style="height: 20px; display: block"></span>
			</div>

			<div class="field">
				<b>이름</b> <input type="text" name="name" id="name"
					placeholder="이름 입력" /> <span id="nameText"
					style="height: 20px; display: block"></span>
			</div>

			<div class="field">
				<b>닉네임</b> <input type="text" name="nickname" id="nickname"
					placeholder="닉네임 입력" /> <span id="nickText"
					style="height: 20px; display: block"></span>
			</div>

			<div class="field">
				<b>이메일</b> <input type="text" name="email" id="email"
					placeholder="이메일 입력" /> <span id="emailText"
					style="height: 20px; display: block"></span>
			</div>
			...
			<div class="field birth">
				<b>주민등록번호</b> 
				<input type="password" name="resident" id="resident" placeholder="주민등록번호 입력" maxlength="13"  />
			...
			<div class="field tel-number">
				<b>휴대전화</b> <input type="text" name="phone" id="phone"
					placeholder="전화번호 입력" maxlength="13" /> <span id="phoneText"
					style="height: 20px; display: block"></span>
			</div>
			<div class="field">
				<!-- 5. 주소-->
				...
				<b>주소</b><input type="text" name="address" id="address"
					...
					id="sample6_detailAddress" /> <input type="hidden" type="text"
